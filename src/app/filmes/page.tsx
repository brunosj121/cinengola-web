        ...
        <div>
          ...
          {totalResults && (
            <p className="text-sm text-foreground/50 mt-0.5 text-right">
              {totalResults.toLocaleString()} filmes
            </p>
          )}
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <AnimatePresence mode="wait">
          {!loading && movies.length === 0 ? (
            ...
            >
              <Film size={48} className="mx-auto text-foreground/20 mb-4" />
            ...
            >
              {movies.map((movie, index) => (
                ...
                >
                  <MovieCard movie={movie} variant="movie" priority={index < 12} />
                </motion.div>
              ))}
            </motion.div>
          )}
        ...
        >
          {loadingMore && (
            ...
            >
              ...
              <p className="text-foreground/50 text-sm">Carregando mais filmes...</p>
            </motion.div>
          )}
          ...
          {!hasMore && movies.length > 0 && (
            ...
            >
              <div className="w-16 h-16 bg-foreground/5 rounded-full flex items-center justify-center mx-auto mb-4">
                <Film size={24} className="text-foreground/30" />
              </div>
