          ...
          {navLinks.map((link, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Ícone com animação - MAIOR NO MOBILE */}
                <div className={`
                  relative z-10 p-3 rounded-xl
                  transition-all duration-300
                  ${active 
                    ? 'bg-red-600/30 text-red-600' 
                    : 'bg-foreground/10 text-foreground/60 group-hover:scale-110'
                  }
                `}>
                  <Icon size={28} />
                </div>
                ...
                {/* Indicador de ativo */}
                {active && (
                  <div className="absolute right-6 w-2 h-2 bg-red-600 rounded-full animate-pulse" />
                )}
              </Link>
            )
          })}
