...
export default function MovieRow({ 
  ...
  useEffect(() => {
    ...
    if (isMobile && !autoScrollInterval.current && movies.length > 0) {
  ...
  }, [movies, direction, isPaused, autoScrollSpeed])
  ...
  return (
    <section className="w-full py-6 sm:py-8 lg:py-10 group/row">
